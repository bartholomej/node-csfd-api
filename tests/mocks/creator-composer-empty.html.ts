...
<script type="application/ld+json">{"@context":"https://schema.org/","@type":"Person","name":"Sven Mikkelsen","image":"//static.pmgstatic.com/assets/images/0224ed11a474c34143bc9ee692d2ac17/empty-image.svg"}</script>
	...
	<header class="box-header">
		...
		<div class="box-header-action">
			<form action="" method="get" data-form="get">
				<select name="sort" data-auto-submit-form="true" data-empty-value="year" id="frm-sort-careerBox-3-sort-sort"><option value="year" selected>seřadit od nejnovějšího</option><option value="rating_count">seřadit podle počtu hodnocení</option><option value="sort_average">seřadit od nejlepšího</option></select>
			</form>
		</div>
	</header>
	<div class="box-content">
				...
				<tr>
					<th colspan="2">Filmy</th>
						...
						<tr>
							...
							<td class="name">
<h3 class="film-title-nooverflow"><i class="icon icon-rounded-square red"></i><a href="/film/1079136-spolu/" class="film-title-name">Spolu</a></h3>							</td>
						</tr>
						<tr>
							<td class="year">
								2019
							...
							<td class="name">
<h3 class="film-title-nooverflow"><i class="icon icon-rounded-square blue"></i><a href="/film/637977-poslouchej/" class="film-title-name">Poslouchej</a></h3>							</td>
						</tr>
			</tbody>
		</table>
	</div>
