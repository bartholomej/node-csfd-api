...
<script type="application/ld+json">{"@context":"https://schema.org/","@type":"Person","name":"Sven Mikkelsen","image":"//static.pmgstatic.com/assets/images/5dc6d583efab14405d659a8d20c27103/empty-image.svg"}</script>
...
<div id="contributionPhoto" class="modal mfp-hide" role="dialog">
	...
	<a class="button button-red link-preloader" href="/prihlaseni/">Přihlásit se</a>
		...
		<section class="fan-club not-in-fanclub">
		</section>


		<div class="box-buttons">

	<a href="http://www.facebook.com/share.php?u=https%3A%2F%2Fwww.csfd.cz%2Ftvurce%2F500749-sven-mikkelsen%2F" class="button button-social share" title="Sdílet na Facebooku."><i class="icon icon-facebook"></i>SDÍLET</a>

<a href="http://twitter.com/intent/tweet?text=Sven%20Mikkelsen%20-%20https%3A%2F%2Fwww.csfd.cz%2Ftvurce%2F500749-sven-mikkelsen%2F" class="button button-social tweet" data-width="550" data-height="350" title="Sdílet na Twitteru.">
...
<script type="text/javascript">
	...
	CSFDAds.complete({"ball":{"page":3,"login":2,"viewId":42934387,"creator_id":500749,"site":"csfd.cz"},"0":{"area":"leaderboard","size":"1000x210,2000x1400,1000x200,1000x210,970x210,998x200,750x200,750x100,970x90,728x90,branding_web"},"1":{"area":"billboard","size":"1000x310,970x310,560x315,480x300,750x300,970x250,970x90,728x90"},"2":{"area":"slide_up","size":"970x310,970x250,950x200,750x300,750x200,728x90,500x200,320x150,320x100,320x50,300x100,300x50,slide_up"},"3":{"area":"mobile_leaderboard","size":"320x100,320x50,300x100,300x50"},"4":{"area":"mobile_billboard","size":"300x300,300x250"}});
</script>
	</body>
