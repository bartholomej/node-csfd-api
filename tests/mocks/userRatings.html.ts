			...
			<div class="user-profile">
				<div class="user-profile-head">
					<div class="label-simple label-favorite-white">
						<a href="/uzivatel/912-bart/hodnoceni/?name=fanclubList&amp;do=modalWindow" class="btn-fanclub ajax" rel="contentModal" data-mfp-main-class="modal-fanclub" data-mfp-src="#panelModal">
							<i class="icon icon-thumb-up"></i>49 fanoušků
				...
				<div class="user-profile-content">
					<figure>
						<img alt="BART!" src="//image.pmgstatic.com/files/images/user/avatars/000/281/281554_1c0fef.jpg" loading="lazy" width="60" height="80" srcset="//image.pmgstatic.com/files/images/user/avatars/000/281/281554_1c0fef.jpg 1x">
					</figure>
					<h1>BART!</h1>
					<p>
...
<nav class="tab-nav tab-nav-count-10">
		...
		<li class="tab-nav-item">
			...
			<a class="tab-link" href="/uzivatel/912-bart/oblibene/filmy/">
				Oblíbené
			</a>
		</li>
		<li class="tab-nav-item">
...
<span class="star-rating"><span class="stars stars-4"></span></span>			</td>
		...
		<tr>
			<td class="name">
<h3 class="film-title-nooverflow"><i class="icon icon-rounded-square blue"></i><a href="/film/1117751-liga-muzske-moudrosti/" class="film-title-name">Liga mužské moudrosti</a> <span class="film-title-info"><span class="info">(2021)</span> <span class="info">(seriál)</span></span></h3>			</td>
			<td class="star-rating-only">
<span class="star-rating"><span class="stars stars-2"></span></span>			</td>
		...
		<tr>
			<td class="name">
<h3 class="film-title-nooverflow"><i class="icon icon-rounded-square red"></i><a href="/film/923577-jak-na-s-johnem-wilsonem/" class="film-title-name">Jak na... s Johnem Wilsonem</a> <span class="film-title-info"><span class="info">(2020)</span> <span class="info">(seriál)</span></span></h3>			</td>
			<td class="star-rating-only">
		...
		<section class="fan-club">
			<div class="fan-club-header">
				...
				<div class="ranking ranking-points">
						31 bodů
					<a class="ranking-points-info" href="/navod-k-pouziti/?section=favorite-users"><i class="icon icon-info"></i></a>
				</div>
			</div>
			...
			<div class="fan-club-content">
				...
				<ul>
					...
					<li>
						<a href="/uzivatel/223175-qidicek/">
							Qidicek
						</a>
					</li>
					<li>
				...
				<div class="box-more-bar">
					<div class="pagination">
	<a href="/uzivatel/912-bart/hodnoceni/?fanclubPage=0" class="page-prev disabled"></a>
	1 - 20
	<a href="/uzivatel/912-bart/hodnoceni/?fanclubPage=2" class="page-next"></a>
</div>
